...
<div class="richtext">
	...
	<p>The Contest Repository provides access via a REST service. Its purpose is to help with automation while accessing and manipulation of resources.</p>
		...
		<li><strong>POST</strong>:
			<ul>
				<li>[any URI], e.g. "/series1/contest2/":
					<ul>
						<li>If the URI corresponds to a resource, creates a new subresource. Expects a parameter "name" which contains the name of the new resource.</li>
	...
	<ul>
		...
		<li><strong>401</strong>: Returned if authentication failed for the user</li>
		<li><strong>201</strong>: Returned if a new resource or directory is created, or if a file is successfully uploaded.</li>
		<li><strong>200</strong>: Returned in any other successful request.</li>
	</ul>
</div>