...
<@util.errorSummary errors=user.validator.errors/>
<form method="post" action="">
	<p>
		<label><span class="title"><em>*</em>Username:</span> <input type="text" name="login" value="${user.login?html}" /></label>
		<@util.error input=user.validator.getError("login")/>
	</p> 
	<p>
	...
	<p><button name="post" value="1" class="submit">register</button></p>
</form>
